def init():
    global spawndialog, selectedSpawnXYZ, selectedSpawnPoint3D, spawn_list, hasClickedSpawn, exploreMode, insertMode, editMode, currentZone, database, config, selectedSpawn, selectedGrid, grid_list, zoneid, gridlinks_list
    config, selectedSpawn, spawndialog, selectedSpawnXYZ, selectedSpawnPoint3D, spawn_list, database, selectedGrid, grid_list, gridlinks_list = None
    zoneid = 0
